...
export const AnnouncementBar: React.FC = () => {
  ...
  return (
    <div className="bg-[#111111] text-white py-1.5 sm:py-2 px-3 sm:px-4 text-xs sm:text-sm font-medium relative z-40 border-b border-neutral-800">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-2">
        ...
        >
          {/* Badge */}
          <span className="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[10px] sm:text-[11px] font-bold bg-[#FFC800] text-[#111111] border border-[#DC9F00] shadow-[inset_0_1px_0_rgba(255,255,255,0.45),0_2px_4px_rgba(0,0,0,0.08)] shrink-0">
            <svg className="w-3 h-3 sm:w-3.5 sm:h-3.5 shrink-0" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span className="hidden xs:inline">Launching </span>Aug 30
          </span>
          ...
          <span className="inline-flex items-center gap-1 font-bold text-[11px] sm:text-xs text-[#FFC800] hover:text-[#FFE066] shrink-0 ml-auto sm:ml-2">
            Support <span className="hidden xs:inline">Us</span> <ArrowRight className="w-3 h-3" />
          </span>
        </a>
