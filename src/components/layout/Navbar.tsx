          ...
          {user ? (
            ...
            <>
              ...
              <button
                ...
                className="inline-flex items-center justify-center px-4 py-2 text-xs sm:text-sm font-bold text-[#111111] bg-[#FFC800] hover:bg-[#E6B400] border border-[#E5E5E5] rounded-xl transition-all shadow-2xs whitespace-nowrap cursor-pointer"
              >
                Get Started
              </button>
            </>
