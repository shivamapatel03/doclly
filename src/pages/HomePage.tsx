      ...
      <section className="relative pt-6 sm:pt-10 pb-8 overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-5 relative z-10">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2.5">
            ...
            {/* Reddit Follow & News Pill */}
            <a
              href="https://www.reddit.com/user/doclly"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-bold bg-[#F5F5F5] hover:bg-[#EAEAEA] active:bg-[#E0E0E0] text-[#111111] border border-[#D5D5D5] shadow-[inset_0_1px_0_rgba(255,255,255,0.8),0_2px_4px_rgba(0,0,0,0.05),0_1px_2px_rgba(0,0,0,0.04)] hover:shadow-[inset_0_1px_0_rgba(255,255,255,0.8),0_4px_8px_rgba(0,0,0,0.08)] active:shadow-[inset_0_1px_2px_rgba(0,0,0,0.1)] transition-all cursor-pointer group"
            >
              <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div id="main-upload" className="max-w-xl mx-auto mt-2">
            ...
            <p className="text-[11px] sm:text-xs text-[#6B7280] font-medium flex flex-wrap items-center justify-center gap-1.5 pt-3">
              ...
              <span>Doclly is currently in <strong>Beta</strong>. Encountered an issue or have an idea?</span>
              <a
